...
const menuData: MenuProto[] = [];

function tiling(parent: MenuProto) {
...
tiling({id: 0, children: menuTree} as MenuProto);

export async function menuList({parentId = 0}): Promise<{code?: number, data?: MenuProto[]}> {
